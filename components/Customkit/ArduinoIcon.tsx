...
export interface ArduinoIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string
  color?: string
}
...
export default function ArduinoIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path fill={color} d="M10 23h6v2h-6V23zM32 23h6v2h-6V23z" />
      <path fill={color} d="M34,21h2v6h-2V21z" />
    </svg>
  )
}
