...
export function generateL293DCode(
  data: any,
  ...
  const enPin = isMotorA 
    ? getComponentPinForPort('L293D', 'en1', connections, '9')
    : getComponentPinForPort('L293D', 'en2', connections, '10')
  const in1Pin = isMotorA
    ? getComponentPinForPort('L293D', 'in1', connections, '8')
    : getComponentPinForPort('L293D', 'in3', connections, '5')
  const in2Pin = isMotorA
    ? getComponentPinForPort('L293D', 'in2', connections, '7')
    : getComponentPinForPort('L293D', 'in4', connections, '6')
