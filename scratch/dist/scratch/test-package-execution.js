...
const packageResolver_1 = require("../lib/compiler/packages/packageResolver");
const packageDispatcher_1 = require("../lib/compiler/packages/packageDispatcher");
const ultrasonic_hcsr04_1 = require("../lib/registry/components/sensors/ultrasonic_hcsr04");
...
function runPackageExecutionTests() {
    ...
    const resolvedById = (0, packageResolver_1.resolvePackageImplementation)('ultrasonic_hcsr04');
    ...
    const resolvedByObj = (0, packageResolver_1.resolvePackageImplementation)(ultrasonic_hcsr04_1.UltrasonicHCSR04Package);
    ...
    const dispatchResult = (0, packageDispatcher_1.dispatchPackageExecution)('ultrasonic_hcsr04', { instanceName: 'ultrasonic_1' });
    ...
    const mockSubflowPackage = {
        ...
        implementation: { strategy: 'subflow', version: 1 }
    };
    let subflowErrorCaught = false;
    try {
        (0, packageDispatcher_1.dispatchPackageExecution)(mockSubflowPackage);
    }
    catch (err) {
    ...
    const mockNativePackage = {
        ...
        properties: [],
        dependencies: { includes: [], globals: [], setup: [] },
        implementation: { strategy: 'native', version: 1 }
    };
    let nativeErrorCaught = false;
    try {
        (0, packageDispatcher_1.dispatchPackageExecution)(mockNativePackage);
    }
    catch (err) {
